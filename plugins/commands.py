...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('📊 ᴄʜᴇᴄᴋ ʙᴏᴛ ᴜᴘᴛɪᴍᴇ sᴛᴀᴛᴜs', url='https://stats.uptimerobot.com/2fTXm54Nt8/798642753')
            ],[
...
# Ask Doubt on telegram @KingVJ01
    ...
    if data.split("-", 1)[0] == "verify":
        ...
        if AUTO_DELETE_MODE == True:
            k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie File/Video will be deleted in <b><u>{AUTO_DELETE} minutes</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please download this File/Video to your device storage </b>")
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/SuperToppers0'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/SuperToppers')
        ],[
            InlineKeyboardButton('📊 ᴄʜᴇᴄᴋ ʙᴏᴛ ᴜᴘᴛɪᴍᴇ sᴛᴀᴛᴜs', url='https://stats.uptimerobot.com/2fTXm54Nt8/798642753')
        ],[
            InlineKeyboardButton('💁‍♀️ ʜᴇʟᴘ', callback_data='help'),
