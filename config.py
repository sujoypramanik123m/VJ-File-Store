...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002253042763 -1002461765329').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')
...
DB_URI = environ.get("DB_URI", "mongodb+srv://sujoy123m:wTWKGUaxYE7dxb1l@cluster0.zorxb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://supertoppersteam.blogspot.com/2025/02/supertoppers.html") # For More Information Check Video On Yt - @Tech_VJ
